...
const zh = {
  ...
  similar: '相似题目',
  similarHint: '选择一道题放大预览, 关闭后返回当前题目',
  noSimilar: '暂无相似题目',
  tags: '标签',
  openPdf: '打开原始 PDF',
  viewInSourcePaper: '在原卷中查看',
  questionPreview: '原始试卷预览',
  controlDesk: '管理控制台',
  ...
  questionPdf: '题目试卷',
  answerPdf: '答案试卷',
  imageUnavailable: '预生成图片不存在或无法加载',
  exportQuestionAnswer: '导出题目与答案',
  rawText: '原始文本',
  markdown: 'Markdown',
  saveRevision: '保存新版本',
  updateLibrary: '更新题库',
...
const en: Record<keyof typeof zh, string> = {
  ...
  similarHint: 'Choose a question to enlarge it, then close it to return',
  noSimilar: 'No similar questions available',
  tags: 'Tags',
  openPdf: 'Open source PDF',
  viewInSourcePaper: 'View in source paper',
  questionPreview: 'Source paper preview',
  ...
  answerPdf: 'Answer paper',
  imageUnavailable: 'The pre-generated image is missing or could not be loaded',
  exportQuestionAnswer: 'Export question and answer',
  rawText: 'Raw text',
  markdown: 'Markdown',
