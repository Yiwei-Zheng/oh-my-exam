...
from pat_admissions_splitter.cutter import SplitOptions
from pat_admissions_splitter.pipeline import split_downloaded
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--report", type=Path, default=Path("data/reports/pat_admissions_split.jsonl"))
