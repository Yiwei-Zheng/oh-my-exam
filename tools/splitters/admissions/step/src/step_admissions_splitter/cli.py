...
from step_admissions_splitter.cutter import SplitOptions
from step_admissions_splitter.pipeline import split_downloaded
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--processed-root", type=Path, default=Path("data/processed_questions"))
    parser.add_argument("--report", type=Path, default=Path("data/reports/step_admissions_split.jsonl"))
