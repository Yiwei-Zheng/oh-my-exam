...
MESSAGES = {
    "zh": {"description": "从 UAT-UK 官网下载 ENGAA/NSAA 历年卷。", "found": "发现 {count} 个官方 PDF", "done": "下载统计: {counts}"},
    "en": {"description": "Download the official UAT-UK ENGAA/NSAA archive.", "found": "found {count} official PDFs", "done": "download counts: {counts}"},
}
