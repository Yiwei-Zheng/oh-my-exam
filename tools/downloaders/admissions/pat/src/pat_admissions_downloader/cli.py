...
from pat_admissions_downloader.catalog import DEFAULT_ARCHIVE_URL, discover_assets
from pat_admissions_downloader.download import download_assets
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--report", type=Path, default=Path("data/reports/pat_admissions_download.jsonl"))
