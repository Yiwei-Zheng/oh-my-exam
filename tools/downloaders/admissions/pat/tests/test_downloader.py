...
from pat_admissions_downloader.catalog import SolutionPage, parse_archive_html, parse_solution_html
from pat_admissions_downloader.download import download_asset
from pat_admissions_downloader.models import PatAsset
