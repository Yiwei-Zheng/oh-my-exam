...
DEFAULT_AVAILABILITY_INDEX = Path("resources/exam_boards/cie/frank_available_assets.json")
DEFAULT_SUBJECT_AVAILABILITY_DIR = Path("resources/exam_boards/cie/available_assets")
