...
from cie_alevel_downloader.pipeline import crawl_manifest, download_from_manifest, migrate_raw_layout
...
def build_parser() -> argparse.ArgumentParser:
    ...
    download.add_argument("--manifest", type=Path, default=Path("configs/cie_a_level_manifest.json"))
    download.add_argument("--raw-root", type=Path, default=Path("data/raw_papers"))
    ...
    crawl.add_argument("--manifest", type=Path, default=Path("configs/cie_a_level_through_2025_manifest.json"))
    crawl.add_argument("--raw-root", type=Path, default=Path("data/raw_papers"))
    crawl.add_argument("--report", type=Path, default=Path("data/reports/cie_download_status.jsonl"))
    ...
    migrate_layout.add_argument("--raw-root", type=Path, default=Path("data/raw_papers"))
    return parser
