...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--metadata-root", type=Path, default=Path("backend/data/processed_questions"))
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    output_dir = args.output_dir or BACKEND_ROOT / "data/databases" / args.qualification / args.exam_board
