...
from oh_my_exam.pipelines.adapters.step.downloader.catalog import DEFAULT_ARCHIVE_URL, discover_assets
from oh_my_exam.pipelines.adapters.step.downloader.download import download_assets
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--report", type=Path, default=BACKEND_ROOT / "data/reports/step_admissions_download.jsonl")
